    ...
    <div class="container mx-auto px-4 py-4 relative z-10">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            ...
            <div class="flex items-center justify-between w-full md:w-auto">
                ...
                <!-- Mobile menu button -->
                <button id="mobile-menu-button" class="md:hidden text-white focus:outline-none focus:ring-2 focus:ring-orange-500 p-1">
            ...
            <div id="mobile-menu" class="hidden md:flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-6 w-full md:w-auto">

                <!-- Main Navigation -->
                <nav class="flex flex-col md:flex-row flex-wrap gap-2 md:gap-6 text-sm md:text-base w-full md:w-auto">
                    <a href="{{ route('home') }}"
                ...
                <div class="flex flex-col md:flex-row items-start md:items-center gap-4 mt-2 md:mt-0">
                    ...
                    @guest
                        <a href="{{ route('login') }}" class="inline-block">
                            <button class="bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 rounded transition-colors text-sm md:text-base shadow-md hover:shadow-lg w-full md:w-auto">
                                Connexion
                            </button>
                        </a>
                    @else
