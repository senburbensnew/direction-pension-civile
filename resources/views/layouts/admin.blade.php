...
<body class="bg-gray-100">
    <div class="min-h-screen" x-data="{ sidebarOpen: false }">
        <!-- Sidebar -->
        <aside
            class="fixed inset-y-0 left-0 z-50 w-64 bg-gray-800 overflow-y-auto transition-transform duration-300 transform"
        ...
        <!-- Main Content -->
        <div class="flex-1" :class="{ 'ml-0': !sidebarOpen, 'md:ml-64': sidebarOpen }">
            <!-- Top Navigation -->
