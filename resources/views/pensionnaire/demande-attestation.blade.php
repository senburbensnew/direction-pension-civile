...
@section('content')
    {{--     <div class="max-w-7xl mx-auto p-6 bg-white rounded-lg shadow-md">
        ...
        <nav class="text-sm text-gray-600 mb-4">
            ...
            <span class="text-gray-800">Demande d'attestation</span>
        </nav>

        <!-- Page Title & Download Button -->
        <div class="flex justify-between items-center mb-4">
            <h1 class="text-2xl font-semibold text-gray-800">Demande d'attestation</h1>
    ...
    <div class="m-5 max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md">
        ...
        <form action="{{ route('pensionnaire.process-attestation-request') }}" method="POST">
            @csrf
