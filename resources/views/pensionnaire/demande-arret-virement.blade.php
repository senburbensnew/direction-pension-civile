...
@section('content')
    {{--     <div class="max-w-7xl mx-auto p-6 bg-white rounded-lg shadow-md">
        ...
        <div class="flex justify-between items-center mb-4">
            <h1 class="text-2xl font-semibold text-gray-800">Demande d'arret de virement</h1>
    ...
    <div class="m-5 max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md">
        <h2 class="text-2xl font-semibold text-gray-800 mb-6">Demande d'arrêt de virement</h2>

        <form action="{{ route('pensionnaire.process-transfer-stop-request') }}" method="POST">
            @csrf
            ...
            <div class="mb-4">
                <label for="reason" class="block text-sm font-medium text-gray-700">Motif d'arrêt de virement</label>
