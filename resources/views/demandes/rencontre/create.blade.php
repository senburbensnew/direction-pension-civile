...
@php
    $fieldClass = fn (string $field) => 'mt-1 block w-full py-2.5 px-4 border text-sm focus:outline-none focus:ring-2 focus:ring-navy/20 focus:border-navy '
    ...
    <div class="max-w-7xl mx-auto space-y-8">
        ...
        <form action="{{ route('demandes.rencontre.store') }}" method="POST" id="main-form" class="space-y-8"
            ...
            <section class="bg-white border border-gray-200 card-shadow p-6 sm:p-8">
                ...
                <div class="mb-5">
                    <label for="objet" class="block text-sm font-medium text-gray-700">Objet de la rencontre <span class="text-red-500">*</span></label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                    <div>
                        <label for="date_souhaitee" class="block text-sm font-medium text-gray-700">Date souhaitée <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label for="heure_souhaitee" class="block text-sm font-medium text-gray-700">Heure souhaitée <span class="text-red-500">*</span></label>
                ...
                <div class="mb-5">
                    <p class="block text-sm font-medium text-gray-700 mb-2">Plateforme souhaitée <span class="text-red-500">*</span></p>
